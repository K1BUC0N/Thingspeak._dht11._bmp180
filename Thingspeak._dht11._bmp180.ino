...
String apiKey = "OK0SGAA80JLTMIR6";                                     //fill in the api key from thingspeak
const char* ssid = "TNCAPA74C01";                                  //fill in your wifi name
const char* password = "EF23E609DA";                              //fill in your wifi password
